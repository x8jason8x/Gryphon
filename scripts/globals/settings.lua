...
WEAPON_SKILL_POWER  = 1.250; -- Multiplies damage dealt by Weapon Skills.
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 0;   -- refund for the timeless hourglass for Dynamis.
   PRISMATIC_HOURGLASS_COST = 0;    -- cost of the prismatic hourglass for Dynamis.
...
NUMBER_OF_DM_EARRINGS = 6; -- Number of earrings players can simultaneously own from Divine Might before scripts start blocking them (Default: 1)
