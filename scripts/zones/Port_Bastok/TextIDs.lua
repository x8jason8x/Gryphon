...
-- WS Quest
       ASURAN_FISTS_LEARNED = 8806; -- You have learned the weapon skill ‚ÄúAsuran Fists‚Äù!

-- conquest Base
              CONQUEST_BASE = 6525; -- Tallying conquest results...

-- WS Quest
       ASURAN_FISTS_LEARNED = 8807; -- You have learned the weapon skill ìAsuran Fistsî!
